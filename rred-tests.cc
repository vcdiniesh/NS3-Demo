...
NS_LOG_COMPONENT_DEFINE ("RRedTests");
...
{
  uint32_t qSize = StaticCast<RRedQueueDisc> (queue)->GetQueueSize ();
...
{
  LogComponentEnable ("RRedQueueDisc", LOG_LEVEL_INFO);
  ...
  Config::SetDefault ("ns3::RRedQueueDisc::Mode", StringValue ("QUEUE_DISC_MODE_PACKETS"));
  Config::SetDefault ("ns3::RRedQueueDisc::MeanPktSize", UintegerValue (meanPktSize));
  Config::SetDefault ("ns3::RRedQueueDisc::Wait", BooleanValue (true));
  Config::SetDefault ("ns3::RRedQueueDisc::Gentle", BooleanValue (true));
  Config::SetDefault ("ns3::RRedQueueDisc::QW", DoubleValue (0.002));
  Config::SetDefault ("ns3::RRedQueueDisc::MinTh", DoubleValue (5));
  Config::SetDefault ("ns3::RRedQueueDisc::MaxTh", DoubleValue (15));
  Config::SetDefault ("ns3::RRedQueueDisc::QueueLimit", UintegerValue (1000));

  if (redTest == 3) // test like 1, but with bad params
    {
      Config::SetDefault ("ns3::RRedQueueDisc::MaxTh", DoubleValue (10));
      Config::SetDefault ("ns3::RRedQueueDisc::QW", DoubleValue (0.003));
    }
  else if (redTest == 5) // test 5, same of test 4, but in byte mode
    {
      Config::SetDefault ("ns3::RRedQueueDisc::Mode", StringValue ("QUEUE_DISC_MODE_BYTES"));
      Config::SetDefault ("ns3::RRedQueueDisc::Ns1Compat", BooleanValue (true));
      Config::SetDefault ("ns3::RRedQueueDisc::MinTh", DoubleValue (5 * meanPktSize));
      Config::SetDefault ("ns3::RRedQueueDisc::MaxTh", DoubleValue (15 * meanPktSize));
      Config::SetDefault ("ns3::RRedQueueDisc::QueueLimit", UintegerValue (1000 * meanPktSize));
    }
  ...
  tchRed.SetRootQueueDisc ("ns3::RRedQueueDisc", "LinkBandwidth", StringValue (redLinkDataRate),
  ...
  if (writeForPlot)
    {
      filePlotQueue << pathOut << "/" << "rred-queue.plotme";
      filePlotQueueAvg << pathOut << "/" << "rred-queue_avg.plotme";
